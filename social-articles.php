<?php
/*
 Plugin Name: Social Articles TinyMCE
 Plugin URI:  https://github.com/mecanographik/social-articles-tinymce
 Description: This is a fork of Social Articles (for a better UI editor: TinyMCE and editor form improved). Social Articles is the first BuddyPress plugin that let you to create and manage posts from your profile. It supports all buddypres themes, so you don't need to be an expert to use it!
 Version: 1.6
 Author: Broobe, fork by Mecanographik
